A CMP makes it easier for you to meet the legal requirements governing data collection in certain parts of the world,
...
The relevant users should then be informed about the existence of the CMP, as well as where to find it in the app.
